          ...
          <div className="BlogProduct__posts">
            ...
            <ul className="BlogProduct__pagination">
              <li className="BlogProduct__pagination-item BlogProduct__pagination-item--active">
                <Link to="" className="BlogProduct__pagination-item-link">1</Link>
              </li>
              <li className="BlogProduct__pagination-item">
                <Link to="" className="BlogProduct__pagination-item-link">2</Link>
              </li>
              <li className="BlogProduct__pagination-item">
                <Link to="" className="BlogProduct__pagination-item-link">3</Link>
              </li>
            </ul>
          </div>
        </div>
