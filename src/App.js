...
import { AllProduct, Blog, Carts, Des, DetailBlog, DetailReview, DetailWriteReview, Homepage, Login, PageShop, Res } from "./page";
    ...
    <div>
      <Routes>
        <Route path="/" element={<AppLayout />}>
          ...
          <Route path="/DetailWriteReview/:id" element={<DetailWriteReview />} />
